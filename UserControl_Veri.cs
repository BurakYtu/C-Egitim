...
{
    public partial class UserControl_Veri : UserControl
    {
        double t = 0;
        ...
        private void UserControl_Veri_Load(object sender, EventArgs e)
        {
